...
static INT16 PrintResults(char *pcProcessFilename,p563Results_struct *ptResults,char *pcResultFilename,char *pcAdditionalInfo)
{
	...
	if (pcResultFilename!=NULL)
	{
		...
		//fprintf(hFile,"%f\t",ptResults->fPredictedMos);
                fprintf(hFile, "%f %f %f %f ",
                        ptResults->tMutes.fMuteLength,
                        ptResults->tMutes.fSpeechInterruptions,
                        ptResults->tMutes.fSharpDeclines,
                        ptResults->tMutes.fUnnaturalSilenceMean);

                fprintf(hFile, "%f %f %f %f %f %f %f %f %f %f %f %f %f %f ",
                        ptResults->tNoise.fEstBGNoise,
                        ptResults->tNoise.fEstSegSNR,
                        ptResults->tNoise.fSpecLevelDev,
                        ptResults->tNoise.fSpecLevelRange,
                        ptResults->tNoise.fRelNoiseFloor,
                        ptResults->tNoise.fNoiseLevel,
                        ptResults->tNoise.fSnr,
                        ptResults->tNoise.fHiFreqVar,
                        ptResults->tNoise.fSpectralClarity,
                ...
                fprintf(hFile, "%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f ",
                        ptResults->tUnnatural.fConsistentArtTracker,
                        ptResults->tUnnatural.fVtpMaxTubeSection,
                        ptResults->tUnnatural.fFinalVtpAverage,
                        ptResults->tUnnatural.fVtpPeakTracker,
                        ptResults->tUnnatural.fArtAverage,
                        ptResults->tUnnatural.fVtpVadOverlap,
                        ptResults->tUnnatural.fPitchCrossCorrelOffset,
                        ptResults->tUnnatural.fPitchCrossPower,
                        ...
                        ptResults->tUnnatural.fCepADev,
                        ptResults->tUnnatural.fCepSkew,
                        ptResults->tUnnatural.fCepCurt,
                        ptResults->tUnnatural.fLPCCurt,
                        ptResults->tUnnatural.fLPCSkew,
                        ptResults->tUnnatural.fLPCSkewAbs
                        );

                fprintf(hFile, "%f %f %f ",
                        ptResults->tBasicDesc.fSpeechLevel,
                        ptResults->tBasicDesc.fPitchAverage,
                        ptResults->tBasicDesc.fSpeechSectionLevelVar);
